...
class CallAndReferenceGenerator(
    ...
    private fun FirExpression.superQualifierSymbolForField(fieldSymbol: IrFieldSymbol): IrClassSymbol? {
        ...
        val ownFirClassSymbol = type.fullyExpandedType(session).lookupTag.toSymbol(session) as? FirClassSymbol<*>
            ?: return null
        val ownContainingClass = classifierStorage.getIrClassSymbol(ownFirClassSymbol).owner
